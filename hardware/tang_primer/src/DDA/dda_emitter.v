...
`endif
    ...
    div_lut div_lutx(.clk(clk), .oce('b0), .ce(~rst), .reset(rst), .ad(ray_x_abs[12:3]), .dout(div_lut_x));
    div_lut div_luty(.clk(clk), .oce('b0), .ce(~rst), .reset(rst), .ad(ray_y_abs[12:3]), .dout(div_lut_y));
    div_lut div_lutz(.clk(clk), .oce('b0), .ce(~rst), .reset(rst), .ad(ray_z_abs[12:3]), .dout(div_lut_z));
