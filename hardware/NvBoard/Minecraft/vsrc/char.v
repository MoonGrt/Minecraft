module char #(
    ...
    localparam CLK_FREQ = 50_000_000;  // Hz
    localparam W = 48;
    ...
    // 十进制 → ASCII
    //--------------------------------------
    wire [3:0] i_h = fps_int / 100;
    wire [3:0] i_t = (fps_int / 10) % 10;
    wire [3:0] i_o = fps_int % 10;
    wire [3:0] d_t = fps_dec / 10;
    wire [3:0] d_o = fps_dec % 10;
