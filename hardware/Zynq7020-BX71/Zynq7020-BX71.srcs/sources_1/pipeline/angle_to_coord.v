...
module angle_to_coord (
    input  wire signed [`ANGLE_RADIX-1:0] angle,
    output wire signed [`ANGLE_RADIX-1:0] coord_x,
    output wire signed [`ANGLE_RADIX-1:0] coord_y
);

    integer ang;

    reg x_inverse, y_inverse, xy_inverse;
    reg [`ANGLE_RADIX-1:0] x_mapped, y_mapped;
    wire [`ANGLE_RADIX-1:0] coord_rev_x, coord_rev_y;
    ...
    always @(angle) begin
        ...
        if (angle < 0) begin
            ...
            y_inverse = 'b1;
        end else ang = angle % `ANGLE_MODULO;
    ...
    always @(y_mapped) begin
        case (y_mapped)
            ...
            x_mapped = 'd225;
            'd14, 'd15, 'd16, 'd17, 'd18, 'd19, 'd20, 'd21, 'd22, 'd23, 'd24: x_mapped = 'd224;
            'd25, 'd26, 'd27, 'd28, 'd29, 'd30, 'd31, 'd32, 'd33: x_mapped = 'd223;
            'd34, 'd35, 'd36, 'd37, 'd38: x_mapped = 'd222;
            'd39, 'd40, 'd41, 'd42, 'd43, 'd44: x_mapped = 'd221;
            'd45, 'd46, 'd47, 'd48: x_mapped = 'd220;
            'd49, 'd50, 'd51, 'd52, 'd53: x_mapped = 'd219;
            'd54, 'd55, 'd56, 'd57: x_mapped = 'd218;
            'd58, 'd59, 'd60: x_mapped = 'd217;
            'd61, 'd62, 'd63, 'd64: x_mapped = 'd216;
            'd65, 'd66, 'd67: x_mapped = 'd215;
            'd68, 'd69, 'd70: x_mapped = 'd214;
            'd71, 'd72, 'd73: x_mapped = 'd213;
            'd74, 'd75, 'd76: x_mapped = 'd212;
            'd77, 'd78: x_mapped = 'd211;
            'd79, 'd80, 'd81: x_mapped = 'd210;
