...
module map_ram(clka, ena, wea, addra, dina, clkb, enb, addrb, doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,ena,wea[0:0],addra[16:0],dina[4:0],clkb,enb,addrb[16:0],doutb[4:0]" */;
  input clka;
  input ena;
  input [0:0]wea;
  input [16:0]addra;
